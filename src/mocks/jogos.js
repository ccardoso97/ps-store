export const jogos = [
  {
    ...
    foto: require("assets/images/god-of-war-ragnarok.jpg").default,
    preco: 299.99,
  ...
  },
  {
    ...
    descricao:
      "Curta a experiência completa do verdadeiro simulador de corridas... com 25 anos de estrada.",
    foto: require("assets/images/gran-turismo-7.jpg").default,
    preco: 197.93,
    genero: "Corrida",
    distribuidora: "Sony",
  },
  {
    ...
    descricao:
      "Cyberpunk 2077 é um RPG de ação e aventura em mundo aberto ambientado na megalópole de Night City, onde você joga como um mercenário cyberpunk envolvido numa intensa luta pela sobrevivência.",
    foto: require("assets/images/cyberpunk-2077.jpg").default,
    preco: 124.75,
    genero: "FPS/RPG",
  ...
  },
  {
    ...
    foto: require("assets/images/dbz-kakarot.jpg").default,
    preco: 249.90,
    genero: "Luta/RPG",
  ...
  },
  {
    ...
    foto: require("assets/images/fifa-23.jpg").default,
    preco: 338.90,
  ...
  },
  {
    ...
    foto: require("assets/images/elden-ring.jpg").default,
    preco: 338.90,
